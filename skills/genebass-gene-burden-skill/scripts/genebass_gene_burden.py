...
def parse_input(payload: Any) -> Tuple[str, str, Optional[int]]:
...
def unpack_phewas_payload(data: Any) -> Tuple[Optional[Dict[str, Any]], List[Dict[str, Any]]]:
    if data is None:
        return None, []
...
def transform_rows(rows: List[Dict[str, Any]], description_map: Dict[str, str]) -> List[Dict[str, Any]]:

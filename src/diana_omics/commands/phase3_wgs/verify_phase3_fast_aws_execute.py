...
def validate_gpu_smoke_result(payload: Mapping[str, Any], *, csv_root: Path) -> dict[str, Any]:
...
def load_gpu_smoke_result_from_environment() -> tuple[dict[str, Any], Path]:
    ...
    return validate_gpu_smoke_result(payload, csv_root=path.parent), path
...
def main() -> None:
    try:
        ...
        smoke_summary, smoke_path = load_gpu_smoke_result_from_environment()

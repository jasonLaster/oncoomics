...
def diana_raw_contract() -> dict[str, Any]:
    return {
        ...
        "uploadContract": "Upload or transfer Diana raw files only under the diana/inbox prefix with S3-managed AES256 encryption. The AWS bucket policy allows authenticated writes plus anonymous listing and downloads for this prefix.",

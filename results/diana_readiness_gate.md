...
7. Phase 3 bounded developer WGS subset validation on the SEQC2/HCC1395 tumor-normal WGS pair, with full-reference BAM contracts, Mutect2 WGS output, coverage-CNV bins, SBS96 matrix output, and BAM-derived SV evidence.

...
Triage ID: `readiness-triage-hg008-depth-20260617`
...
| hcc1395_wes | packet_has_no_blockers | no | 0 | local-validation;next-readiness-20260617;public-evidence-plus-20260617 | Preserve the packet as a public-sample evidence boundary; do not promote no-call HRD adapters without required inputs. |
...
- Actionable now: `no`
- Closed by runs: `local-validation; next-readiness-20260617; public-evidence-plus-20260617`

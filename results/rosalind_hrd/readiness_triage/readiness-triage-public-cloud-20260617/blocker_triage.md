...
Triage ID: `readiness-triage-public-cloud-20260617`
Packet run: `public-evidence-hg008-depth-20260617`
...
| hcc1395_wes | packet_has_no_blockers | no | 0 | cloud-hcc1395-wes-20260617;hcc1395-wes-materialized-20260617;local-validation;next-readiness-20260617;public-evidence-plus-20260617 | Preserve the packet as a public-sample evidence boundary; do not promote no-call HRD adapters without required inputs. |
...
| hg008 | requires_caller_or_truth_overlap_recompute | no | 2 |  | Run or containerize the relevant caller/overlap lane before changing the packet state. |
...
- Actionable now: `no`
- Closed by runs: `cloud-hcc1395-wes-20260617; hcc1395-wes-materialized-20260617; local-validation; next-readiness-20260617; public-evidence-plus-20260617`

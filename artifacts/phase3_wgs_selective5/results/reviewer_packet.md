...
- Full WES benchmark status: pending
- Full WES benchmark ready for Phase 3: no
- Full WES benchmark intervals: not_run
- Full WES depth-eligible truth variants: not_run
- Full WES contamination status: not_run
- Phase 3 WGS validation status: passed
- Phase 3 WGS complete: yes
- Phase 3 ready for Phase 4 setup: yes
- Phase 3 WGS read pairs/end: 568040077
- Phase 3 WGS read-pair mode: full
- Phase 3 coverage-CNV bins: 631
- Phase 3 SBS96 usable SNVs: 265

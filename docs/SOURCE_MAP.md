...
| [SEQC2 reference materials FTP](https://ftp-trace.ncbi.nlm.nih.gov/ReferenceSamples/seqc/Somatic_Mutation_WG/) and [latest release directory](https://ftp-trace.ncbi.nlm.nih.gov/ReferenceSamples/seqc/Somatic_Mutation_WG/release/latest/) | Truth-set/benchmark artifacts and supporting files for HCC1395 somatic-calling comparisons. Phase 2E uses high-confidence SNV/INDEL v1.2.1 VCFs and high-confidence regions. | Open FTP. | Record exact truth-set version and genome build; Phase 2E validates active-interval overlap status but does not claim full-depth sensitivity. |
